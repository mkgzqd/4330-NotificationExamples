...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    @FXML
    public void startTask1(ActionEvent event) throws InterruptedException {
        ...
        if (task1 == null) {
            ...
            task1.start();
            buttonTask1.setText("End Task 1");
        }
        else{
            task1.end();
            task1 = null;
    ...
    public void startTask2(ActionEvent event) {
        ...
        if (task2 == null) {
            ...
            task2.start();
             buttonTask2.setText("End Task 2");
        } 
        else{
            task2.end();
            task2=null;
    ...
    public void startTask3(ActionEvent event) {
        ...
        if (task3 == null) {
            ...
            task3.start();
             buttonTask3.setText("End Task 3");
        }
        else{
            task3.end();
            task3=null;
